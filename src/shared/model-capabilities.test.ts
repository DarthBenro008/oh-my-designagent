...
describe("getModelCapabilities", () => {
  beforeEach(() => {
    // Prevent real local caches from polluting model-capability expectations.
    spyOn(connectedProvidersCache, "findProviderModelMetadata").mockImplementation(() => undefined)
